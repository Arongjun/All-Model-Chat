...
export const MESSAGE_BLOCK_BUTTON_CLASS = "min-h-11 min-w-11 p-1.5 rounded-md inline-flex items-center justify-center text-[var(--theme-text-tertiary)] hover:text-[var(--theme-text-primary)] hover:bg-[var(--theme-bg-tertiary)]/50 transition-all duration-200 focus:outline-none opacity-70 hover:opacity-100";
...
export const ICON_BUTTON_CLASS = "p-2 text-[var(--theme-text-tertiary)] hover:text-[var(--theme-text-primary)] hover:bg-[var(--theme-bg-tertiary)] rounded-lg transition-colors";
...
export const MENU_ITEM_BUTTON_CLASS = "w-full text-left px-3 py-1.5 text-sm flex items-center gap-2 transition-colors focus:outline-none";
export const MENU_ITEM_DEFAULT_STATE_CLASS = "text-[var(--theme-text-primary)] hover:bg-[var(--theme-bg-tertiary)] focus-visible:bg-[var(--theme-bg-tertiary)]";
export const MENU_ITEM_DANGER_STATE_CLASS = "text-[var(--theme-icon-error)] hover:bg-[var(--theme-bg-danger)] hover:text-[var(--theme-text-accent)] focus-visible:bg-[var(--theme-bg-danger)] focus-visible:text-[var(--theme-text-accent)]";
export const MENU_ITEM_COMPACT_BUTTON_CLASS = "w-full text-left px-3 py-2 text-xs flex items-center gap-2 transition-colors focus:outline-none";
