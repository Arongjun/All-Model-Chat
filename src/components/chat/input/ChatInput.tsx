...
const ChatInputComponent: React.FC = () => {
  ...
  const toolbarProps: ChatInputToolbarProps = {
    ...
    supportsImageOutputMode: capabilities.supportsImageOutputMode,
    supportsPersonGeneration: capabilities.supportsPersonGeneration,
  ...
  const actionsProps: ChatInputActionsProps = {
    ...
    isAttachmentlessImageModel: capabilities.isAttachmentlessImageModel || false,
