...
export const useMainContentViewModel = ({ app }: UseMainContentViewModelOptions) => {
  ...
  const appModalsProps = useMemo(
    () => ({
      ...
      onRefreshModels: chatState.refreshModelsFromApi,
      isRefreshingModels: chatState.isModelsRefreshing,
      modelsRefreshError: chatState.modelsRefreshError,
    }),
    [
      chatState.apiModels,
      ...
      chatState.isModelsRefreshing,
      chatState.modelsRefreshError,
      chatState.refreshModelsFromApi,
